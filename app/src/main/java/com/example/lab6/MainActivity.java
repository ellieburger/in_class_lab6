...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int[] transPhtotIdArray = new int[]{R.drawable.trans1, R.drawable.trans2,
        ...
        for(int i = 0;i<transData.length;i++)
        {
            ...
            transData[i].photo = transPhtotIdArray[i];
        }
        ...
        String[] messageArray = new String[]{"訊息一", "訊息二", "訊息三", "訊息四", "訊息五", "訊息六"};
